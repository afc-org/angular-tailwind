...
As you can see we have multiple branches:
 - **master**: This branch stores the latest stable version of @afc/angular-tailwind.
 - **dev-master**: This is the **development** branch of @afc/angular-tailwind, and this is where everything is happening before releasing on master
