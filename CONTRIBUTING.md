...
If you notice any bugs in the code, see some code that can be improved, or have features you would like to be added, please create a [bug report](https://github.com/afc-org/angular-tailwind/issues/new?template=bug-report---.md) or a [feature request](https://github.com/afc-org/angular-tailwind/issues/new?template=feature-request---.md)!
...
**@afc-org/angular-tailwind** is an open-source project, so pull requests are always welcomed (_always_ ❤️).
...
As you can see we have multiple branches:
 - **master**: This branch stores the latest stable version of @afc-org/angular-tailwind.
 - **dev-master**: This is the **development** branch of @afc-org/angular-tailwind, and this is where everything is happening before releasing on master
